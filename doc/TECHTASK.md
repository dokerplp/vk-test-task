...
| Стартовая страница | 29.03.2022 | Выполнено |<ul><li>- [x] На стартовой странице должно быть окно регистрации / авторизации </li><li>- [x] Если останется время реализовать сброс пароля и регистрацию через google </li></ul> | |
...
| Мой профиль | 30.03.2022 | Выполнено | Обязательные поля: <ul><li>- [x] Имя</li><li>- [x] Дата рождения</li><li>- [x] Логин</li><li>- [x] Пароль</li><li>- [ ] Количество и список друзей</li></ul> | |
